...
cat vendor_bootimg/04_dtbdump_ED\k.dtb.* 2>/dev/null >> vendor_bootimg/04_dtbdump_ED\k.dtb
rm -f vendor_bootimg/04_dtbdump_ED\k.dtb.* 2>/dev/null
...
cat mi_ext/product/data-app/MIBrowserGlobal_removable/MIBrowserGlobal_removable.apk.* 2>/dev/null >> mi_ext/product/data-app/MIBrowserGlobal_removable/MIBrowserGlobal_removable.apk
rm -f mi_ext/product/data-app/MIBrowserGlobal_removable/MIBrowserGlobal_removable.apk.* 2>/dev/null
...
cat vendor/lib64/libxmi_high_dynamic_range_cdsp.so.* 2>/dev/null >> vendor/lib64/libxmi_high_dynamic_range_cdsp.so
rm -f vendor/lib64/libxmi_high_dynamic_range_cdsp.so.* 2>/dev/null
...
cat vendor/lib64/camera/com.qti.tuned.munch_ofilm_imx582_wide.bin.* 2>/dev/null >> vendor/lib64/camera/com.qti.tuned.munch_ofilm_imx582_wide.bin
rm -f vendor/lib64/camera/com.qti.tuned.munch_ofilm_imx582_wide.bin.* 2>/dev/null
cat vendor/lib/camera/com.qti.tuned.munch_ofilm_imx582_wide.bin.* 2>/dev/null >> vendor/lib/camera/com.qti.tuned.munch_ofilm_imx582_wide.bin
rm -f vendor/lib/camera/com.qti.tuned.munch_ofilm_imx582_wide.bin.* 2>/dev/null
